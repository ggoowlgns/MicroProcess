...
void WavePlayer_Init(uint32_t my_SpeechReadAddr)
{
  ...
  WaveFileStatus = WavePlayer_WaveParsing(my_SpeechReadAddr);
...
* Return         : None
*******************************************************************************/
char Char_DataLength[30];
char Char_SpeechStartAddress[30];
char Char_SpeechDataOffset[30];
char Char_SampleData[30];
char Char_BitsPerSample[30];
...
void WavePlayer_Start(void)
{
  ...
  //ReadAddr = my_SpeechReadAddr + SpeechDataOffset;
  
  TIM_ITConfig(TIM2, TIM_IT_Update, ENABLE);
  
  //sprintf( Char_DataLength, "Data Size : %d", WAVE_Format.DataSize);
  //LCD_DisplayStringLine(Line0, Char_DataLength);
  
  //sprintf( Char_SpeechStartAddress, "Read Addr : %d", my_SpeechReadAddr);
  //sprintf( Char_SpeechDataOffset, "Data Offset : %d", SpeechDataOffset);
  
  //LCD_DisplayStringLine(Line1, Char_SpeechStartAddress);
  //LCD_DisplayStringLine(Line2, Char_SpeechDataOffset);
}
